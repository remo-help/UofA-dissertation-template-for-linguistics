...
\usepackage[table,dvipnames]{xcolor}  %a more user friendly version of color, 
                                        %the [table] option gives you color range in tables
...
% S\&P, an LSA publication, meets the LSA guidelines.  % this is where your natbib stylesheet is referenced
