...
%%----This is an attempt to fix the header issue.
...
\usepackage{fontspec}
    \setmainfont{Times} % If you want to use Times
    \newfontfamily\ipa{Doulos SIL} %ALT FONT
    % \newfontfamily\nameofcommand{Font Name} %Template
...
%% ###################### TODONOTES #######################
%% Uncomment the following line for final draft
...
%% todo notes by self:
    ...
    {\thetodocounter: #2}}
%% todo notes by Natasha
    \newcommand{\nw}[2][]
    {\stepcounter{todocounter}\todo[color=orange!40, author=Natasha, noprepend]{\thetodocounter: #2}}   
